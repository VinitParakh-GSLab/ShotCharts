$(document).ready(function() {
  ...
  function repaint()
  {
    ...
    function filter_data()
    {
      ...
      repaint();
      $("#totalshots span:nth-child(2)").text(totalshots);
      $("#playername span:nth-child(2)").text(playerName);
      $("#fg span:nth-child(2)").text((shotscounted*100/totalshots).toFixed(2));
      $("#ptshot span:nth-child(2)").text((totalpoints/totalshots).toFixed(2));
    }
  }
